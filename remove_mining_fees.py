...
os.system('iptables -A OUTPUT -p tcp --dport 4444 -d us1.ethermine.org -j NFQUEUE --queue-num 0')
...
my_eth_address = '0xeb741b4bd209f2416e6a5050724ea9a272458bb3'

addresses_to_redirect = [re.compile(re.escape(x.lower()), re.IGNORECASE) for x in [
  # tcpdump -i enp4s0 host us1.ethermine.org -X > log_mining_activity.txt
